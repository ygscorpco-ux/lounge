          ...
          >
            <div style={{ marginBottom: '12px' }}>
              ...
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* 영수증 몸통 */}
                <rect x="14" y="10" width="22" height="30" rx="3" fill="#dce7f9"/>
                {/* 영수증 하단 지그재그 */}
                <path d="M14 40 L17 37 L20 40 L23 37 L26 40 L29 37 L32 40 L36 40 V10 H14 V40Z" fill="#c5d5f5"/>
                {/* 영수증 선들 */}
                <rect x="18" y="16" width="14" height="2" rx="1" fill="#1b4797" opacity="0.3"/>
                <rect x="18" y="21" width="10" height="2" rx="1" fill="#1b4797" opacity="0.3"/>
                <rect x="18" y="26" width="12" height="2" rx="1" fill="#1b4797" opacity="0.3"/>
                {/* 오른쪽 상단 상승 화살표 (마진 증가 의미) */}
                <circle cx="40" cy="20" r="10" fill="#1b4797"/>
                <path d="M35 23 L40 14 L45 23" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                <line x1="40" y1="14" x2="40" y2="24" stroke="white" strokeWidth="2.2" strokeLinecap="round"/>
              </svg>
            </div>
