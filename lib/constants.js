...
// ─── 호환성 alias (기존 코드에서 직접 상수명으로 import 시 사용) ────────────
export const MIN_WAGE_2026 = MIN_WAGE_BY_YEAR[2026]; // = 10320
export const MIN_WAGE_YEAR = new Date().getFullYear();
export const INSURANCE_RATES = getCurrentInsuranceRates(); // 현재 연도 요율
